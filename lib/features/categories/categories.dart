            ...
            children: [
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection('categories').doc(category.id)
                      .collection('services')
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await controller.handleAddService(category.id, serviceNameController.text, serviceDescriptionController.text,
        imageUrl!,);
